...
# Project root = parent of the scribbler/ package
...
# Era configuration (user answer #3: early 80s to 2025)
ERA_SPAN_START = 1980
ERA_SPAN_END = 2025
...
# AUDHD theme lexicon (seed terms for theme detection)
AUDHD_THEMES = {
    ...
    "meltdown": ["meltdown", "meltdowns", "shutdown", "shut down", "frozen", "freeze", "froze", "frozen", "overwhelmed", "flooded", "incapacitated"],
...
# Weak words (from editor consensus: BTL Editorial, BookBaby, etc.)
WEAK_WORDS = [
    "just", "really", "very", "suddenly", "somewhat", "quite", "rather", "actually",
    "basically", "literally", "simply", "totally", "ultimately", "virtually",
    "practically", "seemingly", "apparently", "perhaps", "maybe", "kind of",
    "sort of", "a bit", "slightly", "almost", "nearly", "began to", "started to",
    "proceeded to", "in order to", "due to the fact that", "at this point in time",
    "the fact that", "it is important to note that",
]

# Filter words (create narrative distance)
FILTER_WORDS = [
    "saw", "heard", "felt", "noticed", "realized", "knew", "thought", "wondered",
    "looked", "watched", "seemed", "appeared", "decided", "remembered",
    "recognized", "touched", "smelled", "tasted", "observed", "perceived",
    "understood", "grasped", "sensed",
]

# Crutch phrases (3+ word repeated phrases)
CRUTCH_PHRASES = [
    "it was as if", "the kind of", "the sort of", "I remember", "I knew that",
    "there was a", "there were", "it felt like", "the way that", "the fact that",
    "at the same time", "in that moment", "for a moment", "all of a sudden",
    "out of nowhere", "without thinking", "before I knew it",
]

# Era anachronism watchlist (80s-2025)
# Items are tagged with their first-attested year; flag if scene is set before that year
ANACHRONISM_WATCHLIST = {
    # Technology
    "smartphone": 2007, "iPhone": 2007, "Android": 2008,
    "Facebook": 2004, "Twitter": 2006, "Instagram": 2010, "TikTok": 2016,
    "Snapchat": 2011, "YouTube": 2005, "Netflix streaming": 2007,
    "WiFi": 1997, "Wi-Fi": 1997, "wifi": 1997,
    "Google": 1998, "google": 1998,
    "text message": 1992, "texting": 1994, "SMS": 1992,
    "email": 1971, "e-mail": 1971,
    "laptop": 1983, "modem": 1981, "dial-up": 1980,
    "CD player": 1982, "Walkman": 1979, "Discman": 1984,
    "MP3 player": 1998, "iPod": 2001,
    "DVD": 1996, "VHS": 1976, "Betamax": 1975,
    "cassette": 1962, "vinyl": 1940,
    "pager": 1949, "beeper": 1980,
    "mobile phone": 1983, "cell phone": 1984, "car phone": 1980,
    "internet": 1983, "World Wide Web": 1991, "web browser": 1993,
    "Zoom": 2012, "FaceTime": 2010, "Skype": 2003,
    "Uber": 2011, "Airbnb": 2008,
    "Alexa": 2014, "Siri": 2011,
    # Cultural markers
    "9/11": 2001, "September 11": 2001,
    "COVID": 2019, "pandemic": 2019, "lockdown": 2020,
    # Slang by decade (rough)
    "awesome": 1980, "rad": 1980, "grody": 1982, "gag me": 1982,
    "totally": 1980, "like": 1980, "whatever": 1983, "duh": 1983,
    "dude": 1985, "as if": 1990, "talk to the hand": 1994,
    "phat": 1993, "da bomb": 1995, "tight": 1995,
    "lit": 2015, "yeet": 2014, "cap": 2019, "no cap": 2019,
    "slay": 2016, "bet": 2017, "sus": 2020,
    # Brands/products
    "Tamagotchi": 1996, "Furby": 1998, "Beanie Baby": 1993,
    "Polly Pocket": 1989, "Easy-Bake Oven": 1963,
}

# Comp-title seed list (neurodiversity memoir + hybrid)
COMP_SEED_LIST = [
...
WORD_SWAPS = {
    ...
    "problem": "pattern",
    "issue": "thing",
    "incomplete": "not yet connected",
    "behind": "at your own pace",
    "error": "hmm",
    "wrong": "let's look at this",
    "overdue": "resting",
    "fail": "revisit",
    "failure": "revisit",
    "bad": "worth a look",
...
# Default palette — calm blues (user answer #6)
PALETTE = {
    "bg": "#F7F8FA",          # warm off-white with blue tint
    "surface": "#EEF1F5",
    "card_bg": "#E8EDF3",
    "text_primary": "#1A2332",
    "text_muted": "#5C6878",
    "accent": "#4A6FA5",       # calm blue
    "accent_dark": "#365680",
    "accent_light": "#7B9BC8",
    "border": "#D1D9E3",
    "success": "#5B8C6E",      # muted green for "resting" status
    "warning": "#B8956A",      # muted gold
    "status_seedling": "#A8C4E0",
    "status_growing": "#7B9BC8",
    "status_shaping": "#4A6FA5",
    "status_polishing": "#365680",
    "status_resting": "#9BA8B8",
}
