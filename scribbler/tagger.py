...
def _classify_entity(name: str, context_sentence: str = "") -> str:
    ...
    if context_sentence:
        # "X said", "X came", "X went", "X left", etc. — person indicators
        if re.search(r'\b' + re.escape(name) + r'\b\s+(said|told|smiled|laughed|cried|nodded|looked|walked|sat|stood|gave|took|put|felt|knew|thought|remembered|came|went|left|arrived|returned|waved|turned|started|stopped|began|hugged|kissed|greeted|called|visited|met|saw|heard|watched|noticed|realized|decided|wondered|imagined|believed|hoped|feared|loved|hated|liked|wanted|needed|tried|managed|forgot|recalled|understood|learned|discovered|found|lost|kept|dropped|held|carried|brought|bought|made|built|broke|fixed|opened|closed|entered|followed|led|pushed|pulled|lifted|threw|caught|ran|fell|rose|reached|stretched|turned|waited|stayed|remained|departed|traveled|wandered|searched|showed|offered|accepted|refused|admitted|claimed|stated|declared|whispered|shouted|yelled|screamed|wept|grinned|frowned|stared|gazed|observed|listened|ignored|missed|thought|suspected|doubted|worried|cared|desired|craved|longed|wished|prayed|begged|asked|requested|demanded|ordered|commanded|instructed|advised|warned|threatened|promised|swore|agreed|consented|declined|rejected|denied|confessed|acknowledged|appreciated|thanked|apologized|forgave|blamed|accused|defended|protected|attacked|fought|argued|debated|discussed|explained|described|recounted|reported|informed|reminded|encouraged|discouraged|persuaded|convinced|urged|forced|invited|welcomed|introduced|presented|demonstrated|clarified|summarized|concluded|decided|determined|resolved|settled|confirmed|verified|proved|disproved|challenged|questioned|inquired|investigated|examined|analyzed|studied|taught|coached|mentored|guided|directed|accompanied|joined|participated|attended|explored|created|designed|planned|organized|prepared|assembled|constructed|formed|shaped|crafted|carved|painted|drew|sketched|wrote|composed|performed|played|sang|danced|acted|pretended|dreamed|sensed|experienced|endured|suffered|enjoyed|relished|tasted|smelled|grasped|supported|sustained|maintained|preserved|guarded|sheltered|fed|clothed|dressed|washed|cleaned|swept|organized|sorted|stored|packed|carried|transported|moved|transferred|placed|set|laid|hung|dropped|raised|lifted|pulled|pushed|tapped|knocked|struck|hit|kicked|bit|scratched|pinched|squeezed|pressed|crushed|smashed|broke|shattered|cracked|snapped|split|tore|ripped|cut|sliced|chopped|mixed|stirred|beat|folded|kneaded|rolled|flattened|stretched|twisted|spun|rotated|circled|orbited|traveled|roamed|hunted|sought|pursued|chased|trailed|tracked|traced|located|uncovered|revealed|exposed|disclosed|identified|recognized|spotted|detected|monitored|patrolled|secured|fortified|strengthened|reinforced|backed|endorsed|approved|authorized|permitted|allowed|granted|bestowed|awarded|rewarded|compensated|paid|purchased|acquired|obtained|procured|collected|gathered|accumulated|amassed|hoarded|saved|retained|conserved|covered|hid|concealed|buried|submerged|sunk|descended|plunged|dived|swooped|lunged|leapt|jumped|bounded|sprang|darted|dashed|rushed|hurried|scurried|scrambled|crawled|crept|tiptoed|sneaked|stole|slipped|slid|glided|floated|drifted|strolled|sauntered|marched|strutted|paced|stepped|trod|waded|swam|flew|soared|hovered|sailed|rowed|paddled|drove|rode|cycled|pedaled|skied|skated|rolled|tumbled|crashed|collided|bumped|smacked|punched|stung|tweaked|tugged|yanked|jerked|popped|burst|exploded|erupted|blazed|burned|scorched|singed|charred|roasted|baked|cooked|boiled|simmered|stewed|fried|grilled|broiled|toasted|warmed|heated|melted|thawed|defrosted|froze|chilled|cooled|refreshed|revived|restored|renewed|repaired|mended|patched|sewed|stitched|wove|knitted|crocheted|tied|bound|wrapped|folded|creased|smoothed|ironed|pressed|ground|pounded|whipped|blended|combined|united|connected|linked|attached|fastened|secured|strapped|buckled|buttoned|zipped|hooked|clasped|clipped|pinned|tacked|nailed|screwed|bolted|riveted|welded|soldered|glued|pasted|stuck|adhered|clung|gripped|clutched|embraced|cuddled|snuggled|nestled|burrowed|enveloped|surrounded|encircled|enclosed|confined|restricted|limited|bounded|bordered|edged|framed|outlined|sketched|colored|shaded|tinted|dyed|stained|marked|spotted|dotted|speckled|flecked|sprinkled|dusted|scattered|spread|smeared|rubbed|scoured|rinsed|dried|wrung)\b', context_sentence, re.IGNORECASE):
            return "person"
